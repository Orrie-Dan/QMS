    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Generate and download invoices from quotations</p>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-2">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input
            placeholder="Search quotations for invoicing..."
            value={searchTerm}
              ...
              {data.map((q) => {
                ...
                return (
                  <TableRow key={q.id}>
                    ...
                    <TableCell>
                      <Badge className={s.badge}>{q.status}</Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            try {
                              await downloadInvoicePDF(q, useStore.getState().companySettings, getClient(q.clientId))
                            } catch (error) {
              ...
              {data.length === 0 && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-12 text-muted-foreground">
                    No quotations found for invoicing
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
